...
(use-package modus-operandi-theme ; modus light
  ;; :disabled
  :ensure t
  :config
  (load-theme 'modus-operandi t))

(use-package modus-vivendi-theme ; modus dark
  :disabled
  :ensure t
  :config
